...
const PlayPage = () => {
  ...
  const handleStartNewGame = () => router.push('/play/upload');
  const handleContinue = () => router.push('/play/continue');
        ...
        <div className={styles.fadeIn}>
          <div className={styles.menuPanel}>
            ...
            <nav className={styles.menuNav}>
              ...
              <button className={styles.menuBtn} type="button" onClick={handleContinue}>Enter the Existing Arena</button>
              <button className={styles.menuBtn} type="button" onClick={handleHome}>Home Page</button>
